...
export const indexStatements = [
    ...
    `CREATE INDEX IF NOT EXISTS idx_game_servers_guild_id ON ${t.game_servers}(guild_id)`,
    `CREATE INDEX IF NOT EXISTS idx_game_servers_monitor_enabled ON ${t.game_servers}(monitor_enabled)`,
    `CREATE INDEX IF NOT EXISTS idx_game_servers_channel_id ON ${t.game_servers}(channel_id)`,
